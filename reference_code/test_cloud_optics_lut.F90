! ----------------------------------------------------------------------------------
! Test cloud optics with cloud properties derived from lookup tables. 
! ----------------------------------------------------------------------------------
program test_cloud_optics
  use mo_rte_kind,                    only: wp
  use mo_cloud_optics_lut,            only: ty_cloud_optics_lut, is_lw
  ...
  use mo_load_cloud_coefficients_lut, only: load_and_init_cldop, read_cldpp, write_cldop
  ...
  type(ty_cloud_optics_lut) :: cloud_spec
...
!  print *, '  Using blocks of size ', blockSize
  ...
  ! all done
  print *, 'cloud optics lut test end.'
